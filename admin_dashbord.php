    ...
    <div class="d-flex" id="wrapper"style="background:#f7eeee;">
        ...
        <div class="bg-white" id="sidebar-wrapper" ">
            ...
            <div class="list-group list-group-flush my-3">
                        ...
                        <a href="#" class="list-group-item list-group-item-action bg-transparent second-text active" style="color:crimson;"><i
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    <i class="fas fa-align-left primary-text fs-4 me-3" id="menu-toggle" style="color:crimson;"></i>
